...
| `platform-inventory-2026-09-14-before-issue29-capture.json` | all three | 2026-09-13 18:27Z (02:27 KL) | The **before** half of the mail-store backup round trip (#29). 24 accounts, 158,946 messages, 8,437,924,652 B. The capture stopped Stalwart for 4 s; the in-server count after restart and the count of the restored copy both matched this file on every account — `docs/backup-restore.md`, "The mail store". |
